  ...
  const [formData, setFormData] = useState<ExpenseFormState>(() => {
    if (initialData) {
      return {
        ...
        account: initialData.account as AccountOption,
        incomeOwner: (initialData.type === 'income' && initialData.description.includes('Kanika') ? 'Kanika' : 'Abhinav') as IncomeOwner, // Heuristic for income owner
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors ${formData.type === 'expense'
          ...
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors ${formData.type === 'income'
